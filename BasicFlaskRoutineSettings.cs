...
namespace TreeRoutine.Routine.BasicFlaskRoutine
{
    public class BasicFlaskRoutineSettings : BaseTreeSettings
    {
        ...
        [Menu("Min Life % Auto HP Flask", 11, 10, Tooltip = "Minimum Life percentage when using a life flask.")]
        public RangeNode<int> HPPotion { get; set; }  = new RangeNode<int>(65, 0, 100);

        [Menu("Min Life % Auto Instant HP Flask", 12, 10, Tooltip = "Minimum Life percentage when using an instant life flask.")]
        public RangeNode<int> InstantHPPotion { get; set; } = new RangeNode<int>(35, 0, 100);

        [Menu("Min Mana % Auto Mana Flask", 15, 10, Tooltip = "Minimum Mana percentage when using a mana flask.")]
        public RangeNode<int> ManaPotion { get; set; } = new RangeNode<int>(65, 0, 100);

        [Menu("Min Mana % Auto Instant MP Flask", 16, 10, Tooltip = "Minimum Mana percentage when using an instant mana flask.")]
        public RangeNode<int> InstantManaPotion { get; set; } = new RangeNode<int>(35, 0, 100);

        [Menu("Min Mana Auto Mana Flask", 17, 10, Tooltip = "Minimum Mana points (absolute) when using a mana flask." )]
        public RangeNode<int> MinManaFlask { get; set; } = new RangeNode<int>(50, 0, 100);

        [Menu("Disable Life/Hybrid Flask Offensive/Defensive Usage", 19, 10, Tooltip = "Disables use of Life/Hybrid flasks for defensive and offensive triggers.")]
        ...
        [Menu("Corrupting Blood Stacks", 27, 20, Tooltip = "Minimum amount of corruption stacks before removing ailment.")]
        ...
        [Menu("Min Life %", 41, 40, Tooltip = "Minimum Health percentage when using defensive flasks.")]
        public RangeNode<int> HPPercentDefensive { get; set; } = new RangeNode<int>(50, 0, 100);

        [Menu("Min ES %", 42, 40, Tooltip = "Minimum Energy Shield percentage when using defensive flasks.")]
        public RangeNode<int> ESPercentDefensive { get; set; } = new RangeNode<int>(50, 0, 100);

        [Menu("Treat Offensive Flasks As Defensive", 49, 40, Tooltip = "Enables the use of offensive flasks for defensive triggers.")]
        ...
        [Menu("Min Life %", 51, 50, Tooltip = "Minimum Health percentage when using offensive flasks.")]
        public RangeNode<int> HPPercentOffensive { get; set; } = new RangeNode<int>(50, 0, 100);

        [Menu("Min ES %", 52, 50, Tooltip = "Minimum Energy Shield percentage when using offensive flasks.")]
        public RangeNode<int> ESPercentOffensive { get; set; } = new RangeNode<int>(50, 0, 100);

        [Menu("Enable In Hideout", 60, Tooltip = "Enables flask usage in the hideout.")]
        ...
        [Menu("Hotkey", 131, 130, Tooltip = "Hotkey to use the flask.")]
        public HotkeyNode FlaskSlot1Hotkey { get; set; } = new HotkeyNode(Keys.D1);
        [Menu("Reserve Uses", 132, 130, Tooltip = "Reserves uses of the flask.")]
        ...
        [Menu("Hotkey", 141, 140, Tooltip = "Hotkey to use the flask.")]
        public HotkeyNode FlaskSlot2Hotkey { get; set; } = new HotkeyNode(Keys.D2);
        [Menu("Reserve Uses", 142, 140, Tooltip = "Reserves uses of the flask.")]
        ...
        [Menu("Hotkey", 151, 150, Tooltip = "Hotkey to use the flask.")]
        public HotkeyNode FlaskSlot3Hotkey { get; set; } = new HotkeyNode(Keys.D3);
        [Menu("Reserve Uses", 152, 150, Tooltip = "Reserves uses of the flask.")]
        ...
        [Menu("Hotkey", 161, 160, Tooltip = "Hotkey to use the flask.")]
        public HotkeyNode FlaskSlot4Hotkey { get; set; } = new HotkeyNode(Keys.D4);
        [Menu("Reserve Uses", 162, 160, Tooltip = "Reserves uses of the flask.")]
        ...
        [Menu("Hotkey", 171, 170, Tooltip = "Hotkey to use the flask.")]
        public HotkeyNode FlaskSlot5Hotkey { get; set; } = new HotkeyNode(Keys.D5);
        [Menu("Reserve Uses", 172, 170, Tooltip ="Reserves uses of the flask.")]
